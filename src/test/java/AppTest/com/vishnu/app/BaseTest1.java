...
@Test
public void abhyasiStart() throws Exception{
	click("com.hfn.unified:id/btn_wel_sign_in");
	click("com.hfn.unified:id/checkbox_policy");
click("com.hfn.unified:id/btn_hfn_signin");
sendKeys("com.hfn.unified:id/signin_email","abhyasi.2@mailinator.com");
sendKeys("com.hfn.unified:id/signin_password","abhyasi");
try {
driver.hideKeyboard();
}
catch(Exception e) {}
click("com.hfn.unified:id/btn_sign_in");
click("com.hfn.unified:id/btn_view_more_meditation");
click("com.hfn.unified:id/btn_start");
click("com.hfn.unified:id/btn_end");
assertText("com.hfn.unified:id/meditation_by_text","Guided by");
...
public void assertText(String locator, String text) {
	WebDriverWait wait = new WebDriverWait(this.driver,50);
	Assert.assertEquals(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(locator))).getText(),text);
}
