...
public class ExplorePage {
	...
	@FindBy(id="com.hfn.unified:id/title_explore")
	...
	@FindBy(id="com.hfn.unified:id/btn_view_more_explore")
	public static WebElement btn_view_more;
	
	@FindBy(id="com.hfn.unified:id/toolbar_title")
	public static WebElement textEngage;
